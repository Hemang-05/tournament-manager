...
export default async function FixturesPage({
  ...
  // Sort group keys: Matchday 1, Matchday 2, Quarter-final, Semis, Final etc.
                        ...
                        <div className="grid grid-cols-1 gap-4">
                          {dateMatches.map((match) => {
                            ...
                            return (
                              <div
                                key={match.id}
                                className="group rounded-xl border border-[#E2E8F0] bg-white p-5 shadow-sm transition-all hover:shadow-md"
                              >
